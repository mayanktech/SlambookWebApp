...
<html>
    ...
    <body>
        ...
        <span videoId = "<c:out value="${video.videoId}"></c:out>" class="addVideoLikesInfo" style="cursor: pointer;float:left;margin-left:4%"><c:out value="${video.videoLikesCount}"></c:out>&nbsp;Likes</span> 
          <span class="deleteUserVideo" videoId="<c:out value="${video.videoId}"></c:out>" style="z-index:1000000;float: left;position:relative; left:80%;bottom:100%;display:none"><img videoId="<c:out value="${video.videoId}"></c:out>" src="images/wrong.png" /></span> 
