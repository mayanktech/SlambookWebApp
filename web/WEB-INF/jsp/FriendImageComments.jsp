    ...
    <body>
        <div style="width:100%;height:500px; background-color:tan; overflow: hidden">
            ...
            <div class="imagesCommentsDiv">
                ...
                <img src="resources/users/<c:out value="${requestScope.friendId}"></c:out>/albums/<c:out value="${requestScope.albumId}"></c:out>/<c:out value="${requestScope.imageId}"></c:out>.jpg" style="width:94%; height: 94%;margin: 3%"/>
                    ...
                    <c:forEach items="${requestScope.comments}" var="comments">
                        ...
                        <div class="singleCommentDiv">
                                        ...
                                        <div style="float: left">
                                            <img src="users/<c:out value="${comments.commenterId}"></c:out>/profilepic/<c:out value="${comments.currentProfilePicId}"></c:out>.jpg" style="width:20%;height:60px; margin-left: 0px; display: inline;float:left"/>
